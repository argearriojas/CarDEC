...
def find_resolution(adata_, n_clusters, random):
    """A function to find the leiden resolution tjat corresponds to a prespecified number of clusters, if it exists.
    ...
    Returns:
    ------------------------------------------------------------------
    - resolution: `float`, The resolution that gives n_clusters after running leiden's clustering algorithm.
    """
    ...
    while obtained_clusters != n_clusters and iteration < 50:
        ...
        adata = sc.tl.leiden(adata_, resolution = current_res, random_state = random, copy = True)
