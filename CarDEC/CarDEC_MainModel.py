...
class CarDEC_Model(Model):
    def __init__(self, adata, dims, LVG_dims = None, tol = 0.005, n_clusters = None, random_seed = 201809, 
                 leiden_seed = 0, n_neighbors = 15, pretrain_epochs = 300, batch_size = 64, decay_factor = 1/3, 
        ...
        - leiden_seed: `int`, The seed used for leiden clustering intialization.
        - n_neighbors: `int`, The number of neighbors used for building the graph needed for leiden clustering.
        ...
        - set_centroids: `bool`, If True, intialize the centroids by running leiden's algorithm.
        ...
        if not set_centroids:
            ...
            self.resolution = find_resolution(adata0, n_clusters, leiden_seed)
            adata0 = sc.tl.leiden(adata0, resolution = self.resolution, random_state = leiden_seed, copy = True)
