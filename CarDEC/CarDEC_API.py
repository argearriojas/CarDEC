...
class CarDEC_API:
    ...
    def build_model(self, load_fullmodel = True, dims = [128, 32], LVG_dims = [128, 32], tol = 0.005, n_clusters = None, 
                    random_seed = 201809, leiden_seed = 0, n_neighbors = 15, pretrain_epochs = 2000, batch_size_pretrain = 64,
        ...
        self.model = CarDEC_Model(self.dataset, self.dims, self.LVG_dims, tol, n_clusters, random_seed, leiden_seed, 
	...
	- keep_dispersion: `bool`, If True, the gene, cell dispersions will be returned as well.
        ...
        if not self.count_loaded:
            ...
            if self.LVG:
                ...
                optimizer.build(self.nbmodel.trainable_variables + self.nbmodel_lvg.trainable_variables)
            else:
                optimizer.build(self.nbmodel.trainable_variables)
